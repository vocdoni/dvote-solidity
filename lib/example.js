...
async function main() {
	...
	const processPrice = utils.ParseUnits("1", "ether")
	const processInstance1 = await processFactory.deploy(parentInstanceAddress, namespaceInstance1.address, processPrice)
	...
	const processParams = ProcessContractParameters.fromParams({
		...
		metadata: "ipfs://1234",
		censusRoot: "0x1234__census_root",
		censusUri: "ipfs://1234__census_tree",
		startBlock: 10000,
		blockCount: 110000,
		questionCount: 2,
		maxVoteOverwrites: 3,

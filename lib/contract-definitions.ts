...
/** Smart Contract operations for Trie Proof Test */
export interface TrieProofTestContractMethods {
    verify(siblings: string, rootHash: string, key: string): Promise<string>
}

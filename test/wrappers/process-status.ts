...
describe("Process Status wrapper", () => {
    ...
    it("should fail on invalid process status", () => {
        for (let i = 4; i < 1024; i++) expect(() => new ProcessStatus(i as IProcessStatus)).to.throw
    })
})

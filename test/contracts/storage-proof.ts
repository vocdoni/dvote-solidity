...
import { StorageProofTestContractMethods } from "../../lib"

import { StorageProofTestBuilder, STORAGE_PROOFS_USDT_11328124 as proofs } from "../builders/storage-proof"
...
let contractInstance: StorageProofTestContractMethods & Contract
...
describe("StorageProofTest contract", () => {
    beforeEach(async () => {
        ...
        tx = null
        contractInstance = await new StorageProofTestBuilder().build()
    })

    it("should deploy the contract", async() => {
        const storageProofTestContractInstance = await new StorageProofTestBuilder().build()
        ...
        const localInstance: Contract & StorageProofTestContractMethods = await contractFactory.deploy() as Contract & StorageProofTestContractMethods
